...
<title>page700.com</title>
<link rel="shortcut icon" type="image/x-icon" href="${rootStr }/favicon.ico" />
...
<div class="wrapper">
	<div class="box">
		...
		<div class="column col-sm-10 col-xs-10 col-md-10 col-lg-10" id="main">
...
<script src="${rootStr }/t3/js/jquery-1.9.1.min.js"></script><script src="${rootStr }/t3/js/bootstrap.min.js"></script><script src="${rootStr }/t3/js/scripts.js"></script><script src="${rootStr }/t3/js/main.min.js"></script>
</body>
</html>